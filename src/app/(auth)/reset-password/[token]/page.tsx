    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden">
        ...
        >
            <div className="text-center mb-8">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-900 shadow-xl shadow-slate-900/20 mb-4">
                    <Sparkles className="text-white h-6 w-6" />
                </div>
                <h1 className="text-3xl font-black tracking-tighter text-slate-900">New Password</h1>
